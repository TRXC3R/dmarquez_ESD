//Esta prueba est� hecha con ayuda de chatgpt, en caso de que funcione tomaremos ideas para nuestro proyecto
...
#define MPU6050_ADDRESS 0x68        // Direcci�n I2C del MPU6050 (verifica si es 0x68 o 0x69), ad0 nivel bajo-alto

// Registros del LIS3DH
#define PWR_MGMT_1    0x6B        // Registro de gesti�n de energ�a
#define CONFIG    0x1A             // Registro de configuraci�n DLPF
...
MeasAcc accelerometro(void) {
  ...
  /*l "wakeup" se utiliza para sacar al MPU6050 del modo de suspensi�n (sleep). 
   * Por defecto, el sensor arranca en este modo para ahorrar energ�a. 
   * Al escribir 0x00 en el registro PWR_MGMT_1 se "despierta" el dispositivo, permiti�ndole comenzar 
   * a realizar mediciones de aceleraci�n y giroscopio.*/
   /*El bit 6 ser� el que haga que el aceler�metro salga del modo sue�o. Por defecto esta activo*/
    ...
    // Bucle de lectura continua
        ...
        accele.ax = accel_x / scale;
        accele.ay = accel_y / scale;
        accele.az = accel_z / scale;
        
        // Mostrar los datos en pantalla
        printf("X: %.3f g, Y: %.3f g, Z: %.3f g\n", accele.ax, accele.ay, accele.az);
